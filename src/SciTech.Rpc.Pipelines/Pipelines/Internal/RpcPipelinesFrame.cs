...
namespace SciTech.Rpc.Pipelines.Internal
{
...
#pragma warning restore CA1028 // Enum Storage should be Int32
    ...
    /// </summary>
    internal readonly struct RpcPipelinesFrame
    {
        ...
        public RpcPipelinesFrame(RpcFrameType frameType, int messageNumber, string rpcOperation, RpcOperationFlags flags, uint timeout, IReadOnlyCollection<KeyValuePair<string, string>>? headers)
        {
        ...
        public static bool TryRead(ref ReadOnlySequence<byte> input, int maxFrameLength, out RpcPipelinesFrame message)
        {
            message = default;
            ...
            message = new RpcPipelinesFrame(frameType, messageNumber, operation, operationFlags, timeout, payload, headers);
            return true;
        }
        ...
        private static string ReadString(ref ReadOnlySequence<byte> input, int maxLength)
        {
            ...
            {
                // Temporarily changed to new due to https://github.com/dotnet/roslyn/issues/35764
                Span<byte> local = new byte[(int)length];
        ...
        private static uint ReadUInt32Varint(ref ReadOnlySequence<byte> input)
        {
            ...
            else
            {
                ...
                // Temporarily changed to new due to https://github.com/dotnet/roslyn/issues/35764
                Span<byte> copiedData = new byte[nBytes];
        ...
        {
            throw new NotSupportedException($"{nameof(RpcPipelinesFrame)} should not be tested for equality.");
        }
        ...
        //    return 0;
        //}
        //public static bool operator ==(RpcPipelinesFrame left, RpcPipelinesFrame right)
        //{
        //    ThrowNoEquals();
        //    return false;
        //}
