...
namespace SciTech.Text
{
    internal sealed class Base32Encoder
    {
        public static readonly Base32Encoder Default = new Base32Encoder();

        private const string DefaultEncodingTable = "abcdefghijklmnopqrstuvwxyz234567";
        ...
        public Base32Encoder() : this(DefaultEncodingTable, DefaultPadding) { }

        public Base32Encoder(char padding) : this(DefaultEncodingTable, padding) { }

        public Base32Encoder(string encodingTable) : this(encodingTable, DefaultPadding) { }
