...
namespace SciTech.Rpc.Pipelines.Internal
{
    internal abstract class RpcPipeline : IDisposable
    {
        ...
        private RpcPipelinesFrame.WriteState currentWriteState;

        private int maxFrameLength = RpcPipelinesFrame.DefaultMaxFrameLength;
        ...
        /// <returns></returns>
        public ValueTask<Stream> BeginWriteAsync(in RpcPipelinesFrame responseHeader)
        {
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        public ValueTask EndWriteAsync()
        {
            ...
            RpcPipelinesFrame.EndWrite(payloadLength, this.currentWriteState);
        ...
        /// <returns></returns>
        protected abstract ValueTask OnReceiveAsync(in RpcPipelinesFrame frame);
...
#pragma warning disable CA1031 // Do not catch general exception types
            ...
            try
            {
                ...
                while (!cancellationToken.IsCancellationRequested)
                {
                    ...
                    if (RpcPipelinesFrame.TryRead(ref buffer, this.maxFrameLength, out var frame))
                    {
                        makingProgress = true;
